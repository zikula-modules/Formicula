...
<fieldset>
    ...
    <div class="z-formrow">
        ...
        {formdropdownlist id='default_form' items=$items selectedValue=$modvars.Formicula.default_form}
        <em class="z-sub z-formnote">{gt text='(used when no form is specified)'}</em>
    </div>
    <div class="z-formrow">
        {formlabel for='show_phone' __text='Show phone number'}
        {formcheckbox id='show_phone' checked=$modvars.Formicula.show_phone}
    </div>
    <div class="z-formrow">
        {formlabel for='show_company' __text='Show company'}
        {formcheckbox id='show_company' checked=$modvars.Formicula.show_company}
    </div>
    <div class="z-formrow">
        {formlabel for='show_url' __text='Show URL'}
        {formcheckbox id='show_url' checked=$modvars.Formicula.show_url}
    </div>
    <div class="z-formrow">
        {formlabel for='show_location' __text='Show location'}
        {formcheckbox id='show_location' checked=$modvars.Formicula.show_location}
    </div>
    <div class="z-formrow">
        {formlabel for='show_comment' __text='Show comments textarea'}
        {formcheckbox id='show_comment' checked=$modvars.Formicula.show_comment}
    </div>
    <div class="z-formrow">
    ...
    <div class="z-formrow">
        {formlabel for='use_contacts_as_sender' __text='Use contact mail addresses as sender'}
        {formcheckbox id='use_contacts_as_sender' checked=$modvars.Formicula.use_contacts_as_sender}
        <em class="z-sub z-formnote">{gt text='Disable this if you experience problems with your SMTP server'}</em>
    </div>
</fieldset>
...
<fieldset>
    ...
    <div class="z-formrow">
        ...
        {formcheckbox id='spamcheck' checked=$modvars.Formicula.spamcheck}
    ...
    <div id="formicula_spamcheck_details">
        ...
        <div class="z-formrow">
            ...
            {formtextinput size='20' maxLength='40' id='excludespamcheck' text=$modvars.Formicula.excludespamcheck}
...
<fieldset>
    ...
    <div class="z-formrow">
        ...
        {formcheckbox id='store_data' checked=$modvars.Formicula.store_data}
    </div>
    <div id="formicula_storedata_details">
        <div class="z-formrow">
            {formlabel for='store_data_forms' __text='Only store submissions from these forms'}
            {formtextinput size='20' maxLength='40' id='store_data_forms' text=$modvars.Formicula.store_data_forms}
