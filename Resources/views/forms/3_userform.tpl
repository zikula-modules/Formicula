...
<form id="contactform" action="{modurl modname=Formicula type=user func=send}" method="post">
    ...
    <input type="hidden" name="formname" value="Example reservation form" />
    ...
    <p class="z-clearfix">
        ...
        <span style="float:left; width: 49%;">
            ...
            <input type="date" required class="formborder" name="custom[dateofbirth][data]" id="dateofbirth" size="35" maxlength="40" value="{$custom.dateofbirth.data}" />
        </span>
    </p>
    ...
    <p class="z-clearfix">
        <span style="float:left; width: 49%;">
            ...
            <input type="text" required class="formborder" name="custom[street][data]" id="street" size="35" maxlength="70" value="{$custom.street.data}" />
        </span>
        <span style="float:left; width: 49%;">
            ...
            <input type="text" required class="formborder" name="custom[zipcity][data]" id="zipcity" size="35" maxlength="70" value="{$custom.zipcity.data}" />
        </span>
    </p>
    ...
    <p class="z-clearfix">
        <span style="float:left; width: 49%;">
            ...
            <input type="email" placeholder="{gt text='Enter a valid email address'}" class="formborder" name="userdata[uemail]" id="uemail" value="{$userdata.uemail}" size="35" maxlength="40" />
        </span>
        <span style="float:left; width: 20%;">
            ...
            <input type="text" required class="formborder" name="custom[phone][data]" id="phone" size="12" maxlength="20" value="{$custom.phone.data}" />
        </span>
        <span style="float:left; width: 20%;">
    ...
    <p class="z-clearfix">
        <span style="float:left; width: 49%;">
            ...
            <input type="text" required class="formborder" name="custom[idcard][data]" id="idcard" size="35" maxlength="70" value="{$custom.idcard.data}" />
        </span>
        <span style="float:left; width: 49%;">
            ...
            <span>
                ...
                <input type="radio" required name="custom[gender][data]" id="genderMale" {if $custom.gender.data eq 'Male'}checked{/if} value="{gt text='Male'}" />
    ...
    <p class="z-clearfix">
        <span style="float:left; width: 49%;">
            ...
            <select required class="formborder" name="custom[typeofverhicle][data]" id="typeofverhicle">
                <option value="">{gt text='- Make a choice -'}</option>
        ...
        <span style="float:left; width: 49%;">
            ...
            <input type="number" required class="formborder" name="custom[nrofpersons][data]" id="nrofpersons" size="35" maxlength="70" value="{$custom.nrofpersons.data}" />
        </span>
    </p>
    ...
    <p class="z-clearfix">
        <span style="float:left; width: 49%;">
            ...
            <input type="text" required pattern="{literal}\d{1,2}[/-]\d{1,2}[/-](?:\d{4}|\d{2}){/literal}" title="{gt text='Please enter a valid date (mm/dd/yyyy).'}" class="formborder datepicker" name="custom[rentalstart][data]" id="rentalstart" size="35" maxlength="40" value="{$custom.rentalstart.data}" />
        </span>
        <span style="float:left; width: 49%;">
            ...
            <input type="text" required pattern="{literal}\d{1,2}[/-]\d{1,2}[/-](?:\d{4}|\d{2}){/literal}" title="{gt text='Please enter a valid date (mm/dd/yyyy).'}" class="formborder datepicker" name="custom[rentalend][data]" id="rentalend" size="35" maxlength="40" value="{$custom.rentalend.data}" />
        </span>
    </p>
    ...
    <p class="z-clearfix">
        ...
        <textarea placeholder="{gt text='Your comments here...'}" class="formborder" rows="4" cols="45" id="comment" name="userdata[comment]">{$userdata.comment}</textarea>
    </p>
